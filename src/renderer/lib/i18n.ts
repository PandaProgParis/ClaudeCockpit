...
export interface Translations {
  ...
  legend: string
  projectSessions: (count: number) => string
...
export const en: Translations = {
  ...
  legend: 'Legend',
  projectSessions: (count) => `${count} session${count > 1 ? 's' : ''}`,
  projectTotalCost: 'Total cost',
  ungroupedProject: 'Unknown project',
...
export const fr: Translations = {
  ...
  legend: 'Légende',
  projectSessions: (count) => `${count} session${count > 1 ? 's' : ''}`,
  projectTotalCost: 'Coût total',
  ungroupedProject: 'Projet inconnu',
